...
const AccountInfoPage = () => {
    const [userInfo, setUserInfo] = useState({
        // check if user logged in exists, if it does, print user info, if not, leave the field null 
        email: loggedInUser? loggedInUser.email : null,
        firstName: loggedInUser? loggedInUser.firstName : null,
        lastName: loggedInUser? loggedInUser.lastName : null,
